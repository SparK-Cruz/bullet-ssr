...
import { customElements, HTMLElement } from "./window.js";
...
export default function frag(...args) {
    ...
    const external = { tagName, bhtml, bcss, behavior, frags, initAll, fragNames, customElements };
    ...
    class Fragment extends HTMLElement {
        ...
        whenInit() {
            return new Promise((resolve, reject) => {
                ...
                // Not innited yet? Check every cycle
        ...
        removeEventListener(type, listener = null) {
            return this.#engine.removeEventListener(type, listener);
        }

        removeAllEventListeners(callback = null) {
            return this.#engine.removeAllEventListeners(callback);
        }
