...
export default class Router {
    ...
    constructor(map, root = '') {
        ...
        window.addEventListener('popstate', e => {
            ...
            this.go({url: window.location.pathname});
        });
    }
    ...
    async mount() {
        ...
        await this.#pile.reduce(async (prev, step) => {
            ...
            if (step.component) {
                ...
                frag.document = document;
                frag.window = document.defaultView;
            ...
            step.slots = Object.fromEntries(await Promise.all(
                Object.entries(step.slots).map(async ([slot, component]) => {
                    ...
                    slotFrag.document = document;
                    slotFrag.window = document.defaultView;
